  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [CustomProperties]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/CustomProperties>} _array
 */
InlineResponse20031.prototype._array = undefined;
