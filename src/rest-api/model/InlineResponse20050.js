  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [GenericEvents]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/GenericEvents>} _array
 */
InlineResponse20050.prototype._array = undefined;
