...
import {SpeakersRelations} from './SpeakersRelations';

/**
 * The Speakers model module.
 * @module model/Speakers
 * @version 1.0.0
 */
export class Speakers {
  /**
   * Constructs a new <code>Speakers</code>.
   * Speaker
   * @alias module:model/Speakers
   * @class
   */
  constructor() {
  }
  ...
  /**
   * Constructs a <code>Speakers</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Speakers} obj Optional instance to populate.
   * @return {module:model/Speakers} The populated <code>Speakers</code> instance.
   */
  static constructFromObject(data, obj) {
    if (data) {
      obj = obj || new Speakers();
      ...
      if (data.hasOwnProperty('relations'))
        obj.relations = SpeakersRelations.constructFromObject(data['relations']);
    }
    return obj;
  }
}
 ...
 */
Speakers.prototype.enabled = undefined;

/**
 * @member {String} displayName
 */
Speakers.prototype.displayName = undefined;

/**
 * ID
 * @member {String} id
 */
Speakers.prototype.id = undefined;

/**
 * Name
 * @member {String} name
 */
Speakers.prototype.name = undefined;

/**
 * Channel
 * @member {Number} channel
 */
Speakers.prototype.channel = undefined;

/**
 * Description
 * @member {String} description
 */
Speakers.prototype.description = undefined;

/**
 * Created date
 * @member {String} createdDate
 */
Speakers.prototype.createdDate = undefined;

/**
 * Last modified
 * @member {String} lastModified
 */
Speakers.prototype.lastModified = undefined;
