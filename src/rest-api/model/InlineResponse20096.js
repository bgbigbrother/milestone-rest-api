 ...
 * @version 1.0.0
 */
export class InlineResponse20096 {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [RegisteredClaims]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/RegisteredClaims>} _array
 */
InlineResponse20096.prototype._array = undefined;
