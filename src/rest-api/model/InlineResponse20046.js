  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [EventTypeGroups]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/EventTypeGroups>} _array
 */
InlineResponse20046.prototype._array = undefined;
