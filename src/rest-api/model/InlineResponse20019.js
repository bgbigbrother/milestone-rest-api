  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = Owner.constructFromObject(data['data']);
...
/**
 * @member {module:model/Owner} data
 */
 ...
 */
InlineResponse20019.prototype.tasks = undefined;

/**
 * @member {Array.<module:model/ResourceList>} resources
 */
InlineResponse20019.prototype.resources = undefined;
