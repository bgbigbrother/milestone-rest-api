 ...
 * @version 1.0.0
 */
export class InlineResponse20091 {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [LicenseDetails]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/LicenseDetails>} _array
 */
InlineResponse20091.prototype._array = undefined;
