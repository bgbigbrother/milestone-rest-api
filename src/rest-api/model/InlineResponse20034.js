...
import {MotionDetections} from './MotionDetections';
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [MotionDetections]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/MotionDetections>} _array
 */
InlineResponse20034.prototype._array = undefined;
