  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [ClientSettings]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/ClientSettings>} _array
 */
InlineResponse20030.prototype._array = undefined;
