  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = GenericEventDataSources.constructFromObject(data['data']);
...
/**
 * @member {module:model/GenericEventDataSources} data
 */
InlineResponse20060.prototype.data = undefined;

/**
 * @member {Array.<module:model/TaskList>} tasks
 */
InlineResponse20060.prototype.tasks = undefined;

/**
 * @member {Array.<module:model/ResourceList>} resources
 */
InlineResponse20060.prototype.resources = undefined;
