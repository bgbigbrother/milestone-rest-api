 ...
 * @version 1.0.0
 */
export class InlineResponse20087 {
  /**
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('array'))
        obj._array = ApiClient.convertToType(data['array'], [LicenseInformations]);
    }
    return obj;
  }
}
...
/**
 * @member {Array.<module:model/LicenseInformations>} _array
 */
InlineResponse20087.prototype._array = undefined;
